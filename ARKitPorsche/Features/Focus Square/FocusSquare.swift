...
class FocusSquare: SCNNode {
    ...
    static let fillColor = #colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1)
	...
	override init() {
        ...
        let s9 = Segment(name: "s9", corner: .bottomLeft, alignment: .vertical)
        let s10 = Segment(name: "s10", corner: .bottomLeft, alignment: .horizontal)
        ...
        s9.simdPosition += float3(0, 0, 0)
        s10.simdPosition += float3(0, 0, 0)
